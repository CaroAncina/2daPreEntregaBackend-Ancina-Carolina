...
router.post('/products/:pid', isAuthenticated, isUser, addProductToCart); 
router.put('/:cid/products/:pid', isAuthenticated, isUser, updateProductQuantity); 
router.delete('/:cid', isAuthenticated, isUser, clearCart); 
router.delete('/:cid/products/:pid', isAuthenticated, isUser, removeProductFromCart); 
